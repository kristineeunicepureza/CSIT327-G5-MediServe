...
def signup_view(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            user.municipality = request.POST.get('municipality')
...
def main_menu_view(request):
    ...
    return render(request, 'main_menu.html', {'latest_announcement': latest_announcement})
...
def admin_profile_view(request):
    ...
    context = {'user': request.user, 'total_orders': total_orders, 'total_medicines': total_medicines,
